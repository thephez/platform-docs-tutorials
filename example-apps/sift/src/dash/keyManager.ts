 ...
 *
 * This app only ever needs `getAuth()` — submitting/editing a submission
 * and proposing/co-signing suspend, restore, or revoke actions all sign
 * with the CRITICAL auth key (key 2).
 *
 ...
 * — 1 submitter + 3 panelists — from a single mnemonic: it's a separate
